  ...
  return (
    <div className='post'>
      ...
      <div className={(props.post.likedBy.length && props.post.comments.length) ? 'post-numbers' : 'post-numbers hidden'}>
        <div className='likes'>
          <svg aria-hidden='true' focusable='false' data-prefix='fas' data-icon='thumbs-up' className='svg-inline--fa fa-thumbs-up' role='img' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>

  ...
  return (
    <div className='post'>
      ...
      <div className='post-numbers'>
        <div className='likes'>
          <svg aria-hidden='true' focusable='false' data-prefix='fas' data-icon='thumbs-up' class='svg-inline--fa fa-thumbs-up' role='img' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
      ...
      <div className='post-react'>
        <div className='react-btn like-react'>
          <svg aria-hidden='true' focusable='false' data-prefix='far' data-icon='thumbs-up' class='svg-inline--fa fa-thumbs-up ' role='img' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
        ...
        <div className='react-btn'>
          <svg aria-hidden='true' focusable='false' data-prefix='far' data-icon='message' class='svg-inline--fa fa-message ' role='img' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
        ...
        <div className='react-btn'>
          <svg aria-hidden='true' focusable='false' data-prefix='far' data-icon='share-from-square' class='svg-inline--fa fa-share-from-square ' role='img' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 576 512'>
